...
class _LocationToPageState extends State<LocationToPage> {
  ...
  String _carrierLabel = 'Carrier'; // Add this line to track label
  ...
  void initState() {
    ...
    // Add focus listeners to trigger rebuilds
  ...
  String _getCarrierType(String code) {
    ...
    // Add your logic here to determine if it's forklift or trolley
    // Example logic (modify according to your business rules):
  ...
  // Add this method to handle manual text changes
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      centerTitle: true,
      title: const Text('Receive Transfer', style: GRNConstants.headerStyle),
      actions: [
    ...
    return Column(
      children: [
        ProgressStepsWidget(
          ...
          forkliftCode: _transferData.forkliftCode?.isNotEmpty == true
              ? _transferData.forkliftCode
              : null,
          sourceLocationCode: null, // This page doesn't have source location
  ...
  Widget _buildScanInputs() {
    return Column(
      children: [
        // Forklift Input with dynamic label
        ScanInputWidget(
          controller: _forkliftController,
          focusNode: _forkliftFocus,
          label: _carrierLabel, // Use dynamic label instead of 'Carrier'
          icon: Icons.forklift,
          isActive: true,
          isCompleted: false,
  ...
  void _addStockItem() {
    ...
    // Auto-focus destination if this is the first stock item
